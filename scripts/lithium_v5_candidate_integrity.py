"""Create or verify the frozen V5 quality-text candidate and input prefix."""
...
MANIFEST = ROOT / "data" / "research" / "lithium_v5_candidate_freeze.json"
STATIC_FILES = (
    "src/lithium/walkforward.py",
    "src/lithium/live_signal_ledger.py",
    "scripts/build_lithium_v5_walkforward.py",
    "scripts/record_lithium_v5_prospective_decision.py",
    "data/research/lithium_v5_walkforward_report.json",
    "data/research/lithium_v5_walkforward_rows.csv",
)
DATASETS = (
    ...
    ("data/research/lithium_v5_prospective_decisions.csv", "signal_date"),
)
...
def current_manifest() -> dict[str, Any]:
    return {
        "version": "lithium-v5-quality-text-candidate-freeze-v1",
