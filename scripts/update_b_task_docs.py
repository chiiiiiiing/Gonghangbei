...
def write_progress_doc() -> None:
    ...
    lines = [
        ...
        "- 真实文本来源审计：120/120 通过，四类各 30 条且 URL 全局唯一，见 `查看材料/真实文本来源核验报告.md`",
    ...
    lines.extend(
        [
            ...
            "| 第二阶段 | 100+ 文本样本 | 已联网替换并程序化核验 | 120 条、四类各 30 条、URL 全局唯一，逐条见 `源文本核验明细.csv` |",
...
def write_manual_todo_doc() -> None:
    lines = [
        ...
        "## 本轮已完成",
        "",
        "- 真实文本：120 条完成程序化联网核验，四类各 30 条、URL 全局唯一，逐条见 `源文本核验明细.csv`。",
