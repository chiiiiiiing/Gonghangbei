...
| 验证集 | 2022—2023，共23篇；MAE 2.66pct，RMSE 3.61pct | 只用于选择正则强度 |
| 持久性基线 | 同一验证文本对应目标的MAE 3.01pct | 单文本Ridge验证MAE低约0.35pct（约11.6%） |
...
- 趋势为正且预测加速度为正时使用完整风险缩放仓位，否则使用 50%；
