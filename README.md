...
每条数据保留来源网址、下载时间和 SHA-256。四条路线共完成381个非重叠滚动预测观测；2025年至最新的82个观测是规则建立后回看的时间留出，不是真正前瞻OOS。规则增强路线相对市场基线的时间留出准确率差为 `-13.41` 个百分点，20个交易日移动区块Bootstrap 95%区间为 `[-21.95%, -7.32%]`，因此当前结论仍为“回顾性时间留出文本预测增量尚未建立”。规则于2026-09-02冻结，真正前瞻OOS从其后的新数据开始累计。
